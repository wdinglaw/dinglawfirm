...
NAV = """<header class="site-header" aria-label="Main header">
    <div class="container nav-row">
      ...
      <nav id="site-nav" class="site-nav" data-menu aria-label="Primary">
        ...
        <a href="/san-jose-child-custody-lawyer/">Child Custody</a>
        <a href="/spousal-support-attorney-santa-clara-county/">Support</a>
        <a href="/san-jose-prenup-postnup-lawyer/">Prenuptial Agreements</a>
        <a href="/insights.html">Insights</a>
        <a href="/contact.html">Contact</a>
        <a class="btn" href="https://calendly.com/wdinglaw/consultation" target="_blank" rel="noopener">Schedule a Consultation</a>
      </nav>
    </div>
  </header>"""
